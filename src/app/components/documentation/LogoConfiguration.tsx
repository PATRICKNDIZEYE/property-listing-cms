export const LogoConfiguration = () => {
    return (
        <>
            ...
            <div className="p-6 rounded-md border mt-4 border-border dark:border-dark_border">
                <p className="text-base font-medium text-midnight_text dark:text-gray flex lg:flex-row flex-col" >1. Change Logo over here : <span className="font-semibold text-base overflow-x-auto">src/components/Layout/Header/Logo/index.tsx</span>  </p>
  ...
  <p>/&#x3E;</p>
  <p className="ms-2">&#x3C;Image</p>
    <p className="ms-5">src=&#x22;/images/footer/footer-logo.png&#x22;</p>
